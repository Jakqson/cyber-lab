#### Intro to CyberSec
Install VMs: Kali Linux, Metasploitable2, Windows 10, Windows Server 2019
...
Create folder structure: /Labs, /Reports, /Screenshots, /CTFs, /Certs

Learn basic Git: push, commit, clone, branching
###### Clone
Used to copy a project from GitHub to your computer.
> git clone https://github.com/jakqson/cyber-lab.git
###### Commit
> git add .  
...
Set up Obsidian vault with templates: Lab Note, Report Draft, Tool Reference
...
Create accounts: TryHackMe, HackTheBox, HackerOne, Bugcrowd, CTFtime
